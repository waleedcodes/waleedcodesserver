              ...
              <div className="about_2">
                <div className="col-md-12" id="abt_2main">
                  <div className="abt_1">
                    ...
                    >
                      My Collage name is (GCMS) Abbottabd, khyber pakhtunkhwa.
                      It is very near to my home. I go to my Collage with my
                      elder brother and other friends. My Collage has a
                      beautiful double storey building. There are 90+ rooms in
                      our Collage. I study in D.com Part 2. I Like my class
                      teacher and my class fellows. They are very kind and
                      helping.
                    </p>
                    <div className="row abt_all">
                      <div className="col-md-12 col-lg-6">
                        ...
                        >
                          <span className="fw-bold">Name : ...</span> Waleed
                          Ishfaq
                        </h6>
                        <h6
                          className={`text-${props.mode === "dark" ? "white" : "dark"
                        ...
                        >
                          <span className="fw-bold">Class : ...</span> D.com
                          Part 2
                        </h6>
                        <h6
                          className={`text-${props.mode === "dark" ? "white" : "dark"
                        ...
                        >
                          <span className="fw-bold">Collage : ...</span> (GCMS),
                          Abbottabad
                        </h6>
                      </div>
                      <div className="col-md-12 col-lg-6">
                        ...
                        >
                          <span className="fw-bold"> Section: ...</span> A
                        </h6>
                        <h6
                          className={`text-${props.mode === "dark" ? "white" : "dark"
                            }`}
                        ...
                        >
                          <span className="fw-bold">Roll No: ...</span> 92
                        </h6>
                      </div>
                    </div>
                  </div>
